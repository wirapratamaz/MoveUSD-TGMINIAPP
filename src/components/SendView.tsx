...
const SendView: React.FC<SendViewProps> = ({ onBackClick }) => {
  ...
  const handleContactSelect = () => {
    // In a real app this would open the send form for the selected contact
    ...
    <div className="h-full -mx-4">
      ...
      <div className="mt-4 px-4">
        ...
        <button 
          ...
          onClick={onBackClick} // Using onBackClick prop
        >
      ...
      <div className="mt-6 px-4">
        ...
        <div 
          ...
          onClick={handleContactSelect} // Using the onBackClick prop indirectly
        >
